...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.captcha_required'
        db.add_column(u'forms_form', 'captcha_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.captcha_required'
        db.delete_column(u'forms_form', 'captcha_required')
    ...
    models = {
        ...
        u'forms.form': {
            ...
            'captcha_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
